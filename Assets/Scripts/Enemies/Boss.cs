...
{
    [Header("Settings")]
    [Tooltip("The max speed at which the enemy moves.")]
    ...
    [Tooltip("The distance at which the enemy begins following the follow target and when the music changes to boss music")]
    public float followRange = 10.0f;

    [Header("Music Settings")]
    [Tooltip("The main music player  in the scene")]
    [SerializeField]
    private AudioSource gameMusicPlayer;
    [Tooltip("Sound track for the boss")]
    [SerializeField]
    private AudioClip bossTrack;
    [Tooltip("Sound track for the level")]
    [SerializeField]
    private AudioClip mainTrackForTheLevel;
    ...
    /// Return:
    /// void (no return)
    /// </summary> this method is commented because this object will not be an enemy but a boss.
    ...
    ///<summary>
    /// Description:
    /// Increments the game manager's number of defeated bosses
    /// Input:
    /// none
    /// Return:
    /// void (no return)
    /// </summary>
    private void IncrementBossesDefeated()
    {
        if (GameManager.instance != null && !GameManager.instance.gameIsOver)
        {
