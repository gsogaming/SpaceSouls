...
public class GameManagerArena : MonoBehaviour
{
    ...
    [SerializeField] private int gameManagerArenaScore = 0;
    ...
    public static int score
    {
        get
        {
            return instance.gameManagerArenaScore;
        }
        set
        {
            instance.gameManagerArenaScore = value;
        }
    }

    // The highest score obtained by this player
    [Tooltip("The highest score achived on this device")]
    ...
    [Tooltip("The number of bosses that must be defeated to win the game")]
    public int bossesToDefeat = 1;
    ...
    public int numberOfEnemiesFoundAtStart;
    public int numberOfBossesFoundAtStart;
    ...
    private void FigureOutHowManyEnemiesExist()
    {
        ...
        numberOfBossesFoundAtStart = bossesFromStatic;
        ...
        if (gameIsWinnable)
        {
            ...
            else if (bossesToDefeat > numberOfBossesFoundAtStart)
            {
                Debug.LogWarning("There are " + bossesToDefeat + " bosses to defeat but only " + numberOfBossesFoundAtStart +
                    " enemies found at start \nThe level can not be completed!");
            }
            else
            {
                ...
                Debug.Log("There are " + bossesToDefeat + " bosses to defeat and " + numberOfBossesFoundAtStart +
                    " bosses found at start \nThe level can completed");
            }
        }
    }
    ...
    {
        enemiesDefeated++;
        if (enemiesDefeated >= enemiesToDefeat && gameIsWinnable && bossesDefeated >= bossesToDefeat)
        {
            LevelCleared();
        }
    }
    ...
    {
        bossesDefeated++;
        if (bossesDefeated >= bossesToDefeat && gameIsWinnable && enemiesDefeated >= enemiesToDefeat)
        {
            LevelCleared();
        }
    }
