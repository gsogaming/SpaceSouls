...
public class Health : MonoBehaviour
{
    ...
    [Header("Boss Slider Settings")]
    [Tooltip("The sliders and graphics for boss's and player's health")]
    public Slider BosshealthSlider;
    public TextMeshProUGUI bossNameText;

    [Header("Player Health Slider Settings")]
    public Slider playerHealthSlider;
    public Image playerHealthSliderFillImage;
    public Animator hpBarPulse;
    ...
    private void SetHealthBar()
    {
        if (gameObject.tag == "Player")
        {
            ...
            {
                playerHealthSliderFillImage.color = lowColor;
                hpBarPulse.SetInteger("AnimState", 1);
            }
        }
    }
    ...
    void HandleDeathWithLives()
    {
        ...
        else
        {
            ...
            {
                gameObject.GetComponent<Boss>().DoBeforeDestroy();
            }
